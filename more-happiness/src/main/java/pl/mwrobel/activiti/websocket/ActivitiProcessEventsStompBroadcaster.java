...
public class ActivitiProcessEventsStompBroadcaster implements
		ActivitiEventListener {
	
	private static final Logger log = LoggerFactory.getLogger(ActivitiProcessEventsStompBroadcaster.class);
	private final Session session;
	private final ObjectMapper om;
	
	public ActivitiProcessEventsStompBroadcaster(Session session) {
